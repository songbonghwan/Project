...
for region in regions:
    ...
    print(f"Train score with Lasso for {region}: {train_score}")
    print(f"Test score with Lasso for {region}: {test_score}")
    ...
    # 예측값 계산
    future_predictions = lasso_model.predict(X_future_scaled)
